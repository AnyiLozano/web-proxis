...
const useTerapeuticNumber = () => {
    const lines = [
        {
            ...
            image: "http://localhost/api-proxis/wp-content/uploads/2021/12/Recurso-4.png",
    ...
    const getHeridas = () : Promise<any> => {
        return axios.get('http://localhost/api-proxis/wp-json/lineas-terapeuticas/get-content-heridas')
        .then((res: any) => {
    ...
    const getUlceras = () : Promise<any> => {
        return axios.get('http://localhost/api-proxis/wp-json/lineas-terapeuticas/get-content-ulceras')
        .then((res: any) => {
    ...
    const getDiabetes = () : Promise<any> => {
        return axios.get('http://localhost/api-proxis/wp-json/lineas-terapeuticas/get-content-diabetes')
        .then((res: any) => {
    ...
    const getHemo = () : Promise<any> => {
        return axios.get('http://localhost/api-proxis/wp-json/lineas-terapeuticas/get-content-hemo')
        .then((res: any) => {
