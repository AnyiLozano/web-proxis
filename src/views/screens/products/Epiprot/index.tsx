...
const Epiprot: FC = (): JSX.Element => {
    ...
    console.log(login)
    const obj = {
        background: "http://localhost/api-proxis/wp-content/uploads/2021/12/Recurso-2-6.png",
        show: true
    }
        ...
        <React.Fragment>
            {
                login.token === undefined ? (
                    ...
                    <React.Fragment>
                        <StyledImage src="http://localhost/api-proxis/wp-content/uploads/2021/12/Recurso-2-1.png" alt="Epiprot Principal Image" />
                        <StyledTerapeuticNumberSection background="http://localhost/api-proxis/wp-content/uploads/2021/12/Recurso 4.png">
                            <Container>
                                <Grid item lg={12} className="flex justify-center">
                                    <StyledImage src="http://localhost/api-proxis/wp-content/uploads/2021/12/Recurso-3-1.png" alt="Epiprot Logo" />
                                </Grid>
