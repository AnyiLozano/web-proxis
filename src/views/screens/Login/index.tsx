...
const Login: FC<{ background: string; show: boolean; logo?: string }> = (
  background
): JSX.Element => {
  const {
    StyledImage,
                  ...
                  <StyledImage
                    src={
                      background.logo !== undefined
                        ? background.logo
                        : "http://api-praxis.eml.com.co/wp-content/uploads/2022/03/pharmaceutical_praxis_23.png"
                    }
                  />
                )}
