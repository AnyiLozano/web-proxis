                        ...
                        </Grid>
                        {
                            width >= 1200 ? (
                                <Grid container className="pb-12 flex justify-center md:justify-start">
                                    ...
                                    <Grid item lg={5}>
                                        <StyledTextSection><b>Praxis Pharmaceutical Colombia Ltda</b></StyledTextSection>
                                        <StyledTextSection><b>Dirección:</b> Cr 12 A No. 83-75 OF 601</StyledTextSection>
                                        <StyledTextSection><b>Mapa</b></StyledTextSection>
                                    </Grid>
                                    <Grid item lg={4}>
                                        <StyledTextSection><b>Teléfono:</b> 601 756 60 06</StyledTextSection>
                                ...
                                <Grid container className="pb-12 flex justify-center md:justify-start">
                                    <Grid item md={12} lg={12} xs={12} sm={12}>
                                        ...
                                        <Grid item lg={12} className="flex justify-center">
                                            <img style={{  marginTop: '4%', }}  src="http://api-praxis.test/wp-content/uploads/2022/03/linkeding.png" alt="linkeding" />
                                        </Grid>
                                    </Grid>
